...
## Predicted Contact matrix: all

```{r}
#| label: plot-matrix-fairfield
#| echo: true
autoplot(synthetic_fairfield)
```
...
# Some results: SIR Modelling: Ours vs Prem
...
#   geom_point() +
#   geom_label_repel(
#     data = filter(conmat_prem_soln_40, time == 1),
#              aes(label = type)) +
#   labs(x = "Time", y = "Value", colour = "Model") +
#   facet_wrap(~name, ncol = 1) + 
